 ...
 *  Dependencies: Bag.java Connection.java
 ...
 *  directed edge is of type {@link Connection} and has a real-valued weight.
...
public class EdgeWeightedDigraph {
    ...
    private Bag<Connection>[] adj;    // adj[v] = adjacency list for vertex v
    ...
    public EdgeWeightedDigraph(int V) {
        ...
        adj = (Bag<Connection>[]) new Bag[V];
        for (int v = 0; v < V; v++)
            adj[v] = new Bag<Connection>();
    }
...
//            addEdge(new Connection(v, w, weight));
    ...
    public EdgeWeightedDigraph(EdgeWeightedDigraph G) {
        ...
        for (int v = 0; v < G.V(); v++) {
            ...
            Stack<Connection> reverse = new Stack<Connection>();
            for (Connection e : G.adj[v]) {
                reverse.push(e);
            }
            for (Connection e : reverse) {
                adj[v].add(e);
            }
        }
    }
     ...
     */
    public Iterable<Connection> adj(int v) {
        validateVertex(v);
        return adj[v];
    }
    ...
    public Iterable<Connection> edges() {
        Bag<Connection> list = new Bag<Connection>();
        for (int v = 0; v < V; v++) {
